...
void main() {
  ...
  group('if modified since', () {
    ...
    test('before last modified', () async {
      ...
      final headers = {
        HttpHeaders.ifModifiedSinceHeader: formatHttpDate(
          modified.subtract(const Duration(seconds: 1)),
        ),
      };
    ...
    test('after last modified', () async {
      ...
      final headers = {
        HttpHeaders.ifModifiedSinceHeader: formatHttpDate(
          modified.add(const Duration(seconds: 1)),
        ),
      };
    ...
    test('after file modification', () async {
      ...
      expect(
        response2.lastModified!.millisecondsSinceEpoch,
